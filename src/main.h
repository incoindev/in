...
static const uint256 hashGenesisBlock("0x0000081cb1c9166c347dfaae9e567db1251afa5535c5e460729d61835627b21a");
static const uint256 hashGenesisBlockTestNet("0x000c763e402f2436da9ed36c7286f62c3f6e5dbafce9ff289bd43d7459327eb");

inline int64_t PastDrift(int64_t nTime)   { return nTime - ((8 * 3 + 10) * 60); } // up to this from the past
...
public:
    ...
    {
        // Protocol switch to support p2pool at InCoin block #0
        ...
        // Before InCoin block #0 - get from pregenerated table
