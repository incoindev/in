...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("IN");
    case mBTC: return QString("mIN");
    case uBTC: return QString::fromUtf8("μIN");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("InCoins"));
    case mBTC: return QString(QObject::tr("Milli-InCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-InCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
